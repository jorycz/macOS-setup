...
enableSecureKeyboard() {
  echo
  osascript ./macOS/SecureKeyboardEntry/enableSecureKeyboardEntry.scpt
}
...
disableSecureKeyboard() {
  ...
  if ! osascript ./macOS/SecureKeyboardEntry/disableSecureKeyboardEntry.scpt ; then showError ; fi
  echo
}
